...
const styles = StyleSheet.create({
  ...
  catPill: { paddingHorizontal: 16, height: 34, borderRadius: 10, alignItems: 'center', justifyContent: 'center' },
  ...
  featuredCard: { width: 240, padding: 14, borderRadius: 14, gap: 8 },
  featCatBadge: { alignSelf: 'flex-start', paddingHorizontal: 10, paddingVertical: 4, borderRadius: 8 },
  ...
  featAvatar: { width: 26, height: 26, borderRadius: 8, alignItems: 'center', justifyContent: 'center' },
  ...
  serviceCard: { marginHorizontal: 16, marginTop: 10, padding: 16, borderRadius: 14, gap: 12 },
  cardTop: { gap: 10 },
  serviceTitle: { fontSize: 15, fontWeight: '600' as const, lineHeight: 22 },
  providerRow: { alignItems: 'center', gap: 6 },
  providerAvatar: { width: 24, height: 24, borderRadius: 8, alignItems: 'center', justifyContent: 'center' },
  ...
  requestBtn: { paddingHorizontal: 18, paddingVertical: 9, borderRadius: 10, alignItems: 'center' },
  requestText: { color: '#FFF', fontSize: 13, fontWeight: '600' as const },
  requestedBtn: { paddingHorizontal: 18, paddingVertical: 9, borderRadius: 10, alignItems: 'center' },
